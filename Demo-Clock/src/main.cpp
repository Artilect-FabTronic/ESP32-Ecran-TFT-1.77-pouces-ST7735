/*
  ...
  Description :   Ce programme permet l'affichage d'une horloge numérique utilisant un écran LCD TFT.
                  Démontre l'utilisation des routines d'impression de polices.

  Auteur :        ArnauldDev (https://fabtronic.artilect.fr/)
  Créé le :       2021-12-11
...
void loop()
{
    if (targetTime < millis())
    {
        ...
        if (ss == 0 || initial)
        {
            ...
            tft.drawCentreString("Fab-Tronic", 120, 48, 2); // Next size up font 2
